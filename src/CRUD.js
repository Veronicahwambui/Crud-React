            ...
            <table className="styled-table ">
                {
                    lists.map((current) => (
                        ...
                        <tr>
                            ...
                            <td>{current.price}</td>
                            <td>
                                <button className='buttonedit' onClick={() => handleEdit(current.id)}>Edit</button>
                                <button className='buttondelete' type='button' onClick={() => handleDelete(current.id)}>Delete</button>
                            </td>
                        </tr>
                    ))
                }
